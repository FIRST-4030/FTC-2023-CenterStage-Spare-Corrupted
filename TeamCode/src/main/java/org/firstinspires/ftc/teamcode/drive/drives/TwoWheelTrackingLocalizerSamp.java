 ...
 *
 */
public class TwoWheelTrackingLocalizerSamp extends TwoTrackingWheelLocalizer {
    ...
    public static double PERPENDICULAR_Y = 4.75;
    ...
    public TwoWheelTrackingLocalizerSamp(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        super(Arrays.asList(
